...
Config.Locations = {
    ["checking"] = {
	    [1] = vector3(308.19, -595.35, 43.29), -- done
	    [2] = vector3(-254.54, 6331.78, 32.43), -- paleto NOT DONE
    },
    ["duty"] = {
        [1] = vector3(310.67, -597.07, 43.28), -- done
        [2] = vector3(-254.88, 6324.5, 32.58), -- paleto NOT DONE
    },
    ["vehicle"] = {
        [1] = vector4(320.26, -583.67, 28.57, 339.83), -- done-ish, could move?
        [2] = vector4(-234.28, 6329.16, 32.15, 222.5), -- paleto NOT DONE
    },
    ["helicopter"] = {
        [1] = vector4(351.58, -587.45, 74.16, 160.5), -- done
    ...
    ["roof"] = {
        [1] = vector4(338.5, -583.85, 1274.16, 245.5), -- put up into the sky cause fuck it
    },
    ["main"] = {
